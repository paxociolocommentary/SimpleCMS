...
@import url( "<?php echo $templateDetails['directory']; ?>/js/lightbox-bootstrap/ekko-lightbox.min.css" );
</style>
...
<script type='text/javascript' src='<?php echo $templateDetails['directory']; ?>/js/bootstrap.js'></script>
<script type='text/javascript' src='<?php echo $templateDetails['directory']; ?>/js/lightbox-bootstrap/ekko-lightbox.min.js'></script>
...
$(function(){
	...
	$( '.lightbox' ).each(function(){
		$( this )
		.attr( 'data-gallery', '<?php echo $pageDetails['title']; ?>' )
		.attr( 'data-title', '<?php echo $pageDetails['title']; ?>' );
